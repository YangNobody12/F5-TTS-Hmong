...
def create_gradio_interface():
    with gr.Blocks(title="F5-TTS ภาษาม้ง Hmong",theme=gr.themes.Ocean()) as demo:
        gr.Markdown("# F5-TTS ภาษาม้ง")
        gr.Markdown("สร้างคำพูดจากข้อความ ด้วย Zero-shot TTS หรือ เสียงต้นฉบับ ภาษาม้ง.")
        ...
        with gr.Row():
            ...
            model_custom = gr.Textbox(label="ตำแหน่งโมเดลแบบกำหนดเอง",value="hf://Pakorn2112/hmong/model_last.pt", visible=False, interactive=True)
        ...
        with gr.Tab(label="Text To Speech"):      
            with gr.Row():
                ...
                with gr.Column():
                    output_audio = gr.Audio(label="เสียงที่สร้าง", type="filepath", show_download_button=True)
            ...
            gr.Examples(
                examples=[ 
                    [
                        "./src/f5_tts/infer/examples/thai_examples/ref_1.wav",
                        "Peb yuav tsum siv dej kom txuag.",
                        "Koj xav noj dab tsi?"
                    ],
                    [
                        "./src/f5_tts/infer/examples/thai_examples/ref_2.wav",
                        "Kuv yuav nco ntsoov qhov chaw no.",
                        "Koj nyob qhov twg?"
                    ],
                    [
                        "./src/f5_tts/infer/examples/thai_examples/ref_3.wav",
                        "Kuv tsau lawm.",
                        "Kuv noj mov tag lawm."
                    ],
                    [
                        "./src/f5_tts/infer/examples/thai_examples/update_80000_gen.wav",
                        "Peb tsev neeg muaj 9 leeg, txhua tus sib hlub thiab sib pab.",
                        "Kuv hu ua Paj Ntaub."
                    ]
                ],
...
def main():
    ...
    demo.launch(inbrowser=True, share=args.share ,debug=True)
